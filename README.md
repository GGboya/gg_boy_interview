...
### 1、Redis的常用数据结构，string类型的底层怎么实现的？
...
### 4、redis缓存问题，key过期了怎么办，为什么redis能O(1)
...
### 3、Goroutine是什么？相比于java中线程或者是OS级别的线程有什么区别？
...
Docker容器化是什么？怎么自定义一个镜像上传？dockerfile和compose容器编排了解过吗？
